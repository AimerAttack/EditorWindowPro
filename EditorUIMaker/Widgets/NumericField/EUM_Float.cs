...
namespace EditorUIMaker.Widgets
{
    ...
    {
        public override GUIIconLib.E_Icon IconType => GUIIconLib.E_Icon.Float;
        ...
        {
            GUILib.FloatField(ref info.Value, info.Label,LayoutOptions());
        }
...
";
        ...
        {
            var code = @"
if(GUILib.FloatField(ref _Logic.{{name}},""{{label}}"",{{layout}}))
{
