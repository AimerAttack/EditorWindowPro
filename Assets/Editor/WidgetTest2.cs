    ...
    public class WidgetTest2 : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.Toggle(
                "DisplayTooltipWhenElidedDisplayTooltipWhenElidedDisplayTooltipWhenElidedDisplayTooltipWhenElided",
                false);
            ...
            if (true)
            {
                ...
                // }
                query = OdinSelector<object>.DrawSelectorDropdown(new GUIContent("code"), currentValueName,
        ...
        private GenericSelector<object> CreateSelector()
        {
            ...
            GenericSelector<object> selector = new GenericSelector<object>("", false,
